...
function userLoged(email, password, select) {
    ...
    fetch( "https://nodejs-middle-project.onrender.com/workers/login", {
        method: "POST",
        headers: {
...
fetch( "https://nodejs-middle-project.onrender.com/clients/login", {
    method: "POST",
    headers: {
        "Content-Type": "application/json",
    },
    ...
    .then(data => {
        ...
        const isToken = data.token;
                ...
                document.cookie = `token=${isToken}; path=/; domain=onrender.com;`;
